...
const getElectronics = (center, beltClearance, PSUPlateThickness) => {
	...
	return translate([center.x + (340 - 12.5) - 215 / 2, center.y - (PSUWidth / 2 + beltClearance + PSUPlateThickness), 0], rotateZ(Math.PI, controlBox));
}
//
